...
int main()
{
    ...
    if (1) {
        ...
        cout << "5.s1的输出应该是abcdefghijabcdehelloUVWXYZ，实际是：" << tj_strncat(s1, s4, 2) << endl;
        cout << "  s1的长度应该是24，                        实际是：" << tj_strlen(s1) << endl;

        cout << "6.s1的输出应该是abcdefghijabcdehelloUVWXYZ，实际是：" << tj_strncat(s1, p5, 100) << endl;
        cout << "  s1的长度应该是24，                        实际是：" << tj_strlen(s1) << endl;
    ...
    if (1) {
        ...
        cout << "9.s1 和p15的输出应该是1，   实际是：" << tj_strcmp(s1,  p15) << endl;
        cout << "10.p15和p16的输出应该是0，   实际是：" << tj_strcmp(p15, p16) << endl;
